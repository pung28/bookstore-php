                    ...
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title">
                                <h4 class="card-title">Thêm chi tiết sách</h4>
                            </div>
                        </div>
                        <div class="iq-card-body">
                            <form method="post" action="index.php?controller=book_detail&action=store" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file" name="bd_image" ">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Giá:</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="version_id" class="form-control" id="exampleFormControlSelect1">
                                        <option value=""> - Choose - </option>
                                        <?php
