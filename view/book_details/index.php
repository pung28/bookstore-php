                    ...
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            ...
                            <div class="iq-card-header-toolbar d-flex align-items-center">
                                <a href="index.php?controller=book_detail&action=create" class="btn btn-primary">Thêm chi tiết sách mới</a>
                            </div>
                        </div>
                        <div class="iq-card-body">
                            <div class="table-responsive">
                                <table class="data-tables table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <th style="width: 7%;">Năm xuất bản</th>
                                        <th style="width: 7%;">Nhà xuất bản</th>
                                        <?php if ($array['hasPart']) { ?>
                                        <th style="width: 8%;">Tập</th>
                                        <?php } ?>
                                    ...
                                    foreach ($array['book_details'] as $book_detail) {
                                        ...
                                        <td><?=$book_detail['id'] ?></td>
                                            ...
                                            <td><img src="<?= $book_detail['image'] ?>" width="200px"></td>
                                            <td><?= $book_detail['quantity'] ?></td>
                                            <td><?= $book_detail['price'] ?></td>
                                            <td><?= $book_detail['publishing_year'] ?></td>
                                            <td><?= $book_detail['publishing_company'] ?></td>
                                            <?php if ($array['hasPart']) { ?>
                                                <td><?=$book_detail['part'] ?></td>
                                            <?php } ?>
                                            <td><?= $book_detail['version_name'] ?></td>
                                            ...
                                            <td>  <?php
                                                ...
                                                ?></td>
                                            <td><a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="index.php?controller=book_detail&action=edit&id=<?= $book_detail['id'] ?>"><i class="ri-pencil-line"></i></a></td>
                                            <td><a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="index.php?controller=book_detail&action=softDeleteBookDetail&id=<?= $book_detail['id'] ?>"><i class="ri-delete-bin-line"></i></a></td>
                                        </tr>
                                        <?php
                                    }
                                    } else {
                                        echo "<tr><td colspan='13'>No book details found.</td></tr>";
                                    }
                                    ?>
                                    </tbody>
                                </table>
                                ...
                                for ($i = 1; $i <= $array['page']; $i++){
                                    ?>
                                    <form style="display: inline-block" method="post" action="index.php?controller=book_detail">
