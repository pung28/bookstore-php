                ...
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    <li>
                        ...
                        <ul id="admin" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            ...
                            <li><a href="index.php?controller=categories" aria-expanded="true"><i class="ri-list-check-2"></i>Danh mục</a></li>
                                ...
                                <table class="data-tables table table-striped table-bordered" style="width:100%">
                                    ...
                                    foreach ($categories as $category){
                                        ...
                                        <tr>
                                            <td><?=$category['id']?></td>
                                            <td><?=$category['name']?></td>
                                            <td><a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="index.php?controller=categories&action=edit&id=<?= $category['id']?>"> <i class="ri-pencil-line"></i></a></td>
                                            <td><a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="index.php?controller=categories&action=softDeleteCategory&id=<?= $category['id']?>"><i class="ri-delete-bin-line"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
