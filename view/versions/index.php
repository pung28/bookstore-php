                ...
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    <li>
                        ...
                        <ul id="admin" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            ...
                            <li><a href="index.php?controller=version"  aria-expanded="true"><i class="ri-book-2-line"></i>Các phiên bản</a></li>
                        </ul>
                    </li>
                    <li>
        ...
        <div class="iq-navbar-custom">
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                ...
                <div class="navbar-breadcrumb">
                    <h5 class="mb-0">Phiên bản</h5>
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.phpl">Admin</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Sản phẩm</li>
                            <li class="breadcrumb-item active" aria-current="page">Phiên bản</li>
                        </ul>
                    </nav>
                </div>
                    ...
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title">
                                <h4 class="card-title">Phiên bản</h4>
                            </div>
                            <div class="iq-card-header-toolbar d-flex align-items-center">
                                <a href="index.php?controller=version&action=create" class="btn btn-primary">Thêm phiên bản</a>
                            </div>
                        </div>
                        <div class="iq-card-body">
                                ...
                                <table class="data-tables table table-striped table-bordered" style="width:100%">
                                    ...
                                    foreach ($versions as $version){
                                        ...
                                        <tr>
                                            <td><?=$version['id']?></td>
                                            <td><?=$version['name']?></td>
                                            <td><a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="index.php?controller=version&action=edit&id=<?= $version['id']?>"> <i class="ri-pencil-line"></i></a></td>
                                            <td><a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="index.php?controller=version&action=softDeleteVersion&id=<?= $version['id']?>"><i class="ri-delete-bin-line"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
