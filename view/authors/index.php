                ...
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    <li>
                        ...
                        <ul id="admin" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            ...
                            <li><a href="index.php?controller=author" aria-expanded="true"><i  class="ri-file-user-line"></i>Tác giả</a></li>
                    ...
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            ...
                            <div class="iq-card-header-toolbar d-flex align-items-center">
                                <a href="index.php?controller=author&action=create" class="btn btn-primary">Thêm tác giả mới</a>
                            </div>
                        </div>
                        <div class="iq-card-body">
                                ...
                                <table class="data-tables table table-striped table-bordered" style="width:100%">
                                    ...
                                    foreach ($authors as $author){
                                        ...
                                        <tr>
                                            <td><?=$author['id']?></td>
                                            <td><?=$author['name']?></td>
                                            <td> <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="index.php?controller=author&action=edit&id=<?= $author['id']?>"><i class="ri-pencil-line"></i></a> </td>
                                            <td><a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="index.php?controller=author&action=softDeleteAuthor&id=<?= $author['id']?>"><i class="ri-delete-bin-line"></i></a> </td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
...
<!-- Mirrored from templates.iqonic.design/booksto/html/admin-author.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Jun 2024 10:59:32 GMT -->
</html>
