...
<head>
    ...
    <script>
        $(document).ready(function() {
            // Load districts and wards when a province is selected
            ...
            // Initial load of districts and wards based on the selected province and district
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="district" class="form-control" id="district">
                                        ...
                                        if ($customer['province_id']) {
                                            $sql = "SELECT id, name FROM districts WHERE province_id = " . $customer['province_id'];
                                            $result = mysqli_query($connect, $sql);
                                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="ward_id" class="form-control" id="ward">
                                        ...
                                        if ($customer['district_id']) {
                                            $sql = "SELECT id, name FROM wards WHERE district_id = " . $customer['district_id'];
                                            $result = mysqli_query($connect, $sql);
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                $selected = ($row['id'] == $customer['ward_id']) ? 'selected' : '';
                                                echo '<option value="' . $row['id'] . '" ' . $selected . '>' . $row['name'] . '</option>';
                                            }
                                        }
                                        ?>
