        ...
        <div id="sidebar-scrollbar">
            <nav class="iq-sidebar-menu">
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    <li>
                        <a href="#admin" class="iq-waves-effect" data-toggle="collapse" aria-expanded="false"><span class="ripple rippleEffect"></span><i class="las la-book"></i><span>Sản phẩm</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    ...
                    <li>
                        <a href="index.php?controller=customer" class="iq-waves-effect"  aria-expanded="true"><span class="ripple rippleEffect"></span><i class="las la-user-tie iq-arrow-left"></i><span>Khách hàng</span></a>
            ...
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                ...
                <div class="navbar-breadcrumb">
                    ...
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.phpl">Admin</a></li>
                    ...
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            ...
                            <div class="iq-card-header-toolbar d-flex align-items-center">
                                ...
                                <a href="index.php?controller=customer&action=create" class="btn btn-primary">Thêm khách hàng mới </a>
                            </div>
                            <?php endif; ?>
                        </div>
                        <div class="iq-card-body">
                            <div class="table-responsive">
                                <table class="data-tables table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $customer['address'] . ' - ' . $customer['ward_name'] . ' - ' . $customer['district_name'] . ' - ' . $customer['province_name'] ?></td>
                                        <?php if ($_SESSION['role'] == 'admin'): ?>
                                            <div class="flex align-items-center list-user-action">
                                               <td><a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="index.php?controller=customer&action=edit&id=<?= $customer['id']?>"><i class="ri-pencil-line"></i></a></td>
                                               <td> <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="index.php?controller=customer&action=softDeleteCustomer&id=<?= $customer['id']?>"><i class="ri-delete-bin-line"></i></a></td>
                                            </div>
                                        <?php endif; ?>
                                    </tr>
                                        <?php
