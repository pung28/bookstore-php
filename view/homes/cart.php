                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="category-nav">
                            ...
                            <ul class="category-nav__menu" id="js-cat-nav">
                                <?php foreach ($cart['category'] as $cate) { ?>
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="current"><a>Giỏ hàng</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="cart-wrapper bg--white mb--80 mb-sm--60">
                    <div class="row">
                        <div class="col-12">
                            <!-- Cart Area Start -->
                            <form method="post" action="index.php?controller=home&action=update_cart" enctype="multipart/form-data" class="form form--cart">
                                <div class="cart-table table-content table-responsive">
                                    <table class="table mb--30">
                                        ...
                                        <tbody>
                                        <?php
                                        foreach ($cart['books'] as $id => $value) {
                                        ?>
                                        <tr>
                                            <td>
                                                <a href="index.php?controller=home&action=detail&id=<?= $id ?>">
                                                <img src="<?= $value['image']?>" alt="product">
                                                </a>
                                            </td>
                                            <td class="wide-column">
                                                <h3><a href="index.php?controller=home&action=detail&id=<?= $id ?>">
                                                        <?= $value['name']?>   <?php if (!empty($value['part'])) { ?>
                                                           - <?= htmlspecialchars($value['part']) ?></span>
                                                        <?php } ?></a></h3>
                                            </td>
                                            <td class="cart-product-price"><strong>
                                                    <?php
                                                    if (is_numeric($value['price'])) {
                                                    echo number_format($value['price'], 0, ',', '.') . ' VND';
                                                    } else {
                                                    echo 'N/A';
                                                    }
                                                    ?></strong></td>
                                            <td>
                                                <div class="quantity">
                                                    <input type="number" class="quantity-input" name="amount[<?= $id ?>]" id="qty1" value="<?= $value['amount']?>" min="1">
                                                </div>
                                            </td>
                                            <td class="cart-product-price"><strong><?= $formattedNum = number_format($value['subtotal'], 0, ',', '.'); ?> VND</strong></td>
                                            <td><a href="index.php?controller=home&action=delete_one_book_in_cart&id=<?= $id ?>"><i class="fa fa-times"></i></a></td>
                                        </tr>
                                        </tbody>
                                        <?php
                                        }
...
<!--                                                <input type="text" name="coupon" id="coupon" class="form__input" placeholder="Mã giảm giá">-->
<!--                                                <button type="submit" class="btn btn-5 btn-style-1 color-1">Áp mã</button>-->
<!--                                            </div>-->
<!--                                        </div>-->
<!--                                    </div>-->
                                    <div class="col-12 text-md-end">
                                        <div class="cart-btn-group">
                                            <button class="btn btn-5 btn-style-1 color-1">Cập nhật</button>
                                            <button class="btn btn-5 btn-style-1 color-1"><a href="index.php?controller=home&action=delete_cart">Xóa giỏ hàng</a></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="cart-page-total bg--white">
                                ...
                                <div class="cart-calculator-table table-content table-responsive">
                                    <table class="table">
                                        <tbody>
                                        <tr class="cart-total">
                                            <form method="post" action="index.php?controller=home&action=checkout">
                                            <th>Tổng cộng</th>
                                            <td><span class="price-ammount">  <?php
                                                    if(empty($cart['books'])) {
                                                        echo 0;
                                                    } else {
                                                        $lastest_value = end($cart['books']);
                                                        $lasest_total = $lastest_value['total'];
                                                        echo number_format($lasest_total, 0, ',', '.') . ' VND';
                                                    }
                                                    ?>VND</span></td>
                                        </tr>
                                        </tbody>
                                    ...
                                    <button type="submit" class="btn btn-6 btn-style-2">Đến thanh toán</button>
                                </form>
