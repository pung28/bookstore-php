...
<!-- Mirrored from htmldemo.net/lazio/lazio/index-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Jun 2024 15:45:47 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="category-nav">
                            ...
                            <ul class="category-nav__menu" id="js-cat-nav">
                                ...
                                <li class="category-nav__menu__item ">
                                    <a href="index.php?controller=home&action=category&id=<?= htmlspecialchars($cate['id']) ?>">
                ...
                <div class="row custom-row">
                    <div class="col-lg-6 offset-lg-3 col-md-8 mb-sm--30">
                        <div class="slider-wrapper owl-carousel right-side-dot" id="homepage-slider-2">
                            ...
                            <div class="single-slider content-top" style="background-image: url(assets/img/slider/home7-slider1.jpg);">
                                <div class="slider-content text-center">
                                    <p class="color--white" data-animation="zoomIn" data-duration=".3s" data-delay=".2s">Sách trinh thám </p>
                                    <h1 class="mb--20 color--white slider-heading-big" data-animation="zoomIn" data-duration=".3s" data-delay=".2s">Giảm giá 50% </h1>
                                    <div class="slider-btn-group" data-animation="fadeInBottom" data-duration=".3s" data-delay=".9s">
                                        <a href="shop.html" class="btn btn-borderd btn-slider color--white color-brand-2 btn-style-1">Mua ngay</a>
                                    </div>
                                </div>
                            </div>
                            <div class="single-slider content-top" style="background-image: url(assets/img/slider/home1-slider2.jpg);">
                                <div class="slider-content text-center">
                                    <p class="color--white" data-animation="zoomIn" data-duration=".3s" data-delay=".2s">Sách thiếu nhi </p>
                                    <h1 class="mb--20 color--white slider-heading-big" data-animation="zoomIn" data-duration=".3s" data-delay=".2s">Giảm giá 30% </h1>
                                    <div class="slider-btn-group" data-animation="fadeInBottom" data-duration=".3s" data-delay=".9s">
                                        <a href="shop.html" class="btn btn-borderd btn-slider color--white color-brand-2 btn-style-1">Mua ngay</a>
                                    </div>
                                </div>
                        ...
                        <div class="row gx-0">
                            <div class="col-md-12 col-sm-6">
                                <div class="promo-box full-width mb-mdsm--10 mb-xsm--10">
                                    <a href="#">
                                        <img src="assets/img/banner/home7-banner1-1.jpg" alt="promo">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-12 col-sm-6">
                                <div class="promo-box full-width">
                                    <a href="#">
                                        <img src="assets/img/banner/home7-banner1-2.jpg" alt="promo">
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                                    ...
                                    <div class="col-4" style="padding: 15px;">
                                        <div class="product-box horizontal bg--white color-3 right-line bottom-line" style="border: 1px solid #ddd; padding: 15px; border-radius: 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1); transition: box-shadow 0.3s ease-in-out; align-items: center; display: flex; flex-direction: column; height: 100%;">
                                            ...
                                            <div class="product-box__action action-1" style="text-align: center; margin-top: 10px;">
                                                <a href="index.php?controller=home&action=add_to_cart&id=<?= htmlspecialchars($book['book_detail_id']) ?>" class="add-to-cart" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to cart">
                        ...
                        <div class="text-center" style="margin-top: 20px;">
                            <a href="index.php?controller=home&action=all_book" class="btn btn-primary">Xem thêm</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="promo-box mb-sm--20">
                            <a href="#"><img src="assets/img/banner/home7-banner2-1.jpg" alt="promo"></a>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="promo-box">
                            <a href="#"><img src="assets/img/banner/home7-banner2-2.jpg" alt="promo"></a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="promo-area section-padding section-sm-padding">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="promo-box">
                    <a href="#"><img src="assets/img/banner/home7-banner3.jpg" alt="promo"></a>
                </div>
            </div>
        </div>
    </div>
...
<!-- Mirrored from htmldemo.net/lazio/lazio/index-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Jun 2024 15:46:46 GMT -->
</html>