            ...
            <div class="container">
                ...
                <section class="single-product bg--white pt--80 pb--80 pt-sm--60 pb-sm--60">
                    <div class="row">
                        <div class="col-lg-6">
                            <?php
                            foreach ($array['book_details'] as $book) {
                            ?>
                            <!-- Tab Content Start -->
                            <div class="tab-content product-thumb-large" id="myTabContent-3">
                                <div class="tab-pane fade show active" id="product-large-one">
                                    <div class="single-product__img easyzoom">
                                        <img src="<?= htmlspecialchars($book['image']) ?>" alt="product">
                                        <a class="popup-btn" href="<?= htmlspecialchars($book['image']) ?>"><i class="fa fa-search-plus"></i>Ảnh chi tiết</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="single-product__content">
                                <div class="single-product__top">
                                    <h2 class="single-product__name"><?= htmlspecialchars($book['name']) ?> - <?= htmlspecialchars($book['part']) ?></h2>
                                ...
                                <div class="single-product__middle">
                                    <div class="row ">
                                        <div class="col-3" style="width: 50% ">
                                            <h3>Tác giả: </h3>
                                                <?= htmlspecialchars($book['author_name']) ?></p>
                                        </div>
                                        <div class="col-3 mb-3">
                                            <h3>Nhà xuất bản: </h3>
                                            <?= htmlspecialchars($book['publishing_company']) ?></p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-3" style="width: 50%">
                                            <h3>Năm sản xuất: </h3>
                                            <?= htmlspecialchars($book['publishing_year']) ?></p>
                                        </div>
                                        <div class="col-3 mb-3">
                                            <h3>Hình thức: </h3>
                                            <?= htmlspecialchars($book['version_name']) ?></p>
                                        </div>
                                    </div>
...
<!--                                        <i class="fa fa-check-circle"></i>-->
                                    ...
                                    <div class="product-action-wrapper">
                                        <a href="index.php?controller=home&action=add_to_cart&id=<?= $book['book_detail_id'] ?>" class="btn add-to-cart btn-style-1 color-1">
                                            Thêm vào giỏ hàng
                                        </a>
                                    </div>
<!--                                    <div class="single-product__btn">-->
<!--                                        <a href="wishlist.html" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to Wishlist"><i class="fa fa-heart-o"></i> Thêm vào danh sách yêu thích</a>-->
<!---->
<!--                                    </div>-->
                                </div>
                                ...
                                <div class="social-buttons">
                                    <a  href="https://facebook.com/" target="_blank" rel="noopener" class="facebook social-button">
                                        <i class="fa fa-facebook"></i>
                                        <span>Like</span>
                                    </a>
                                    <a  href="https://twitter.com/" target="_blank" rel="noopener" class="twitter social-button">
...
<!--                                    <ul class="social">-->
<!--                                        <li class="social__item"><a  href="https://facebook.com/" target="_blank" rel="noopener" class="social__link"><i class="fa fa-facebook social__icon"></i></a></li>-->
<!--                                        <li class="social__item"><a  href="https://twitter.com/" target="_blank" rel="noopener" class="social__link"><i class="fa fa-twitter social__icon"></i></a></li>-->
<!--                                        <li class="social__item"><a href="plus.google.html" class="social__link"><i class="fa fa-google-plus social__icon"></i></a></li>-->
<!--                                        <li class="social__item"><a  href="https://pinterest.com/" target="_blank" rel="noopener" class="social__link"><i class="fa fa-pinterest social__icon"></i></a></li>-->
<!--                                        <li class="social__item"><a  href="https://pinterest.com/" target="_blank" rel="noopener" class="social__link"><i class="fa fa-linkedin social__icon"></i></a></li>-->
<!--                                    </ul>-->
<!--                                </div>-->
                            </div>
                        ...
                        <div class="col-12">
                            <ul class="single-product-tab__head nav nav-tab" id="singleProductTab" role="tablist">
                                <li class="nav-item single-product-tab__item">
                                    <button class="nav-link single-product-tab__link active" id="nav-desc-tab" data-bs-toggle="tab" data-bs-target="#nav-desc" role="tab" aria-controls="nav-desc" aria-selected="true">Nội Dung</button>
                                </li>
                                <li class="nav-item single-product-tab__item">
                                    <button class="nav-link single-product-tab__link" id="nav-details-tab" data-bs-toggle="tab" data-bs-target="#nav-details" role="tab" aria-controls="nav-details" aria-selected="true">Thông tin thêm</button>
                                </li>
                            </ul>
