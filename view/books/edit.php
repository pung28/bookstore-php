                ...
                <div class="col-sm-12">
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            ...
                            ?>
                            <form method="post" action="index.php?controller=book&action=update" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cate_id" class="form-control" id="exampleFormControlSelect1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file" name="book_image">
                                        <label class="custom-file"><img src="<?=$book['book_image'] ?>" width="30" alt=""></label>
                                    </div>
                                </div>
