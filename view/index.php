            ...
            <nav class="iq-sidebar-menu">
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    <li class="active active-menu">
                        <a href="index.php" class="iq-waves-effect"  aria-expanded="true"><span class="ripple rippleEffect"></span><i class="las la-home iq-arrow-left"></i><span>Shop</span></a>
            ...
            <div class="row">
                    ...
                    <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                        <div class="iq-card-header d-flex justify-content-between align-items-center">
                            <div class="iq-header-title">
                                <h4 class="card-title mb-0">Doanh thu tuần</h4>
                            </div>
                        </div>
                        <div class="iq-card-body">
                ...
                <div class="col-md-4">
                    <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                        <div class="iq-card-header d-flex justify-content-between align-items-center">
                            <div class="iq-header-title">
                                <h4 class="card-title mb-0">Tổng</h4>
                            </div>
                        </div>
                        <div class="iq-card-body">
                                ...
                                <div class="dropdown">
                                 ...
                                 <i class="ri-more-fill"></i>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton5">
                                        ...
                                        <a class="dropdown-item" href="#"><i class="ri-delete-bin-6-fill mr-2"></i>Xóa</a>
