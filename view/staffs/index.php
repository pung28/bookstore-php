        ...
        <div id="sidebar-scrollbar">
            <nav class="iq-sidebar-menu">
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    <li>
                        <a href="index.php?controller=staff" class="iq-waves-effect"  aria-expanded="true"><span class="ripple rippleEffect"></span><i class="las la-user-tie iq-arrow-left"></i><span>Người dùng</span></a>
                    ...
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            ...
                            <div class="iq-card-header-toolbar d-flex align-items-center">
                                ...
                                <a href="index.php?controller=staff&action=create" class="btn btn-primary">Thêm người dùng mới</a>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="iq-card-body">
                            <div class="table-responsive">
                                <table class=" table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <th style="width: 14%;">Quyền hạn</th>
                                        <?php if (isset($_SESSION['role']) && $_SESSION['role'] == 'admin'): ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php if (isset($_SESSION['role']) && $_SESSION['role'] == 'admin'): ?>
                                            <div class="flex align-items-center list-user-action">
                                                <td><a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="index.php?controller=staff&action=edit&id=<?=$staff['id']?>"><i class="ri-pencil-line"></i></a></td>
                                                <td><a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="index.php?controller=staff&action=softDeleteStaff&id=<?=$staff['id']?>"><i class="ri-delete-bin-line"></i></a></td>
                                            </div>
                                        <?php endif; ?>
                                    </tr>
                                        <?php
