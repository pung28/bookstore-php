                    ...
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            <div class="new-user-info">
                                <form method = "post" action="index.php?controller=staff&action=store">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="add1">Phone:</label>
                                            <input type="text" name="phone" class="form-control" placeholder="Phone">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="add2">Password:</label>
                                            <input type="password" name="password" class="form-control"  placeholder="Password">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="cname">Role:</label>
                                            <input type="text" name="role" class="form-control" id="cname" placeholder="Role">
                                        </div>
                                    </div>
                                    <hr>
