(function($){
	...
	***********************/
	...
	$('.js-new-books-carousel').owlCarousel({
		items: 3,
		smartSpeed: 500,
	    loop:true,
	    nav: true,
	...
	carouselClasses('.new-books-carousel');
	$('.new-books-carousel').on('translated.owl.carousel', function(event) {
	    carouselClasses('.new-books-carousel')
	});
	...
	***********************/
	...
	$('.js-new-books-carousel-2').owlCarousel({
		items: 2,
		smartSpeed: 500,
	    loop:true,
	    nav: true,
	...
	***********************/
	...
	$('.js-new-books-carousel-3').owlCarousel({
		items: 3,
		smartSpeed: 500,
	    loop:true,
	    nav: true,
